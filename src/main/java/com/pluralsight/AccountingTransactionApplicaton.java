...
public class AccountingTransactionApplicaton {
    ...
    private static void displayMainMenu() {
        ...
        System.out.println("  " + AnsiColors.BLUE + "[D]" + AnsiColors.RESET + " ➕ Add Deposit                        ");
        System.out.println("  " + AnsiColors.BLUE + "[P]" + AnsiColors.RESET + " ➖ Make Payment (Debit)                ");
        System.out.println("  " + AnsiColors.BLUE + "[L]" + AnsiColors.RESET + " 📒 View Ledger                         ");
        System.out.println("  " + AnsiColors.BLUE + "[X]" + AnsiColors.RESET + " ❌ Exit Application                    ");
    ...
    public static void runWelcome() {
        ...
        System.out.println(AnsiColors.YELLOW + "             Welcome to Balancio         " + AnsiColors.RESET);
        System.out.println(AnsiColors.BLUE + AnsiColors.BOLD + "╚════════════════════════════════════════════╝" + AnsiColors.RESET);
